    ...
    <body>
        ...
        <div class="container">
            <div class="card">
                <div class="card-image-container">
                    <img class="main-image"
                        ...
                        alt="Instituto Federal da Bahia - Campus Salvador">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h3 class="card-title">João Henrique</h3>
                    <p class="card-subtitle">
            ...
            <div class="card">
                <div class="card-image-container">
                    <img class="main-image"
                        ...
                        alt="Instituto Federal da Bahia - Campus Vitória da Conquista">
                    <img class="overlay-image"
                        ...
                        alt="João Vitor Perpétuo">
                </div>
                <div class="card-content">
                    <h3 class="card-title">João Vitor Perpétuo</h3>
                    <p class="card-subtitle">
