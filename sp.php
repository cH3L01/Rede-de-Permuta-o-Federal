        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="card-subtitle">
                        Instituto Federal do Norte de Minas Gerais - Arinos
                    </p>
                </div>
                <div class="card-content">
                    <p><button class="btn btn-dark" disabled href="Link.com">Contatar</button></p>
            ...
            <div class="card">
                <div class="card-image-container">
                    ...
                    <img class="overlay-image"
                        src="https://ui-avatars.com/api/?name=Duda+Santos&background=random"
                        alt="DudaSantos">
                </div>
                <div class="card-content">
            ...
            <div class="card">
                <div class="card-image-container">
                    <img class="main-image"
                        ...
                        alt="IFMG Ouro Preto">
                    <img class="overlay-image"
                        src="https://ui-avatars.com/api/?name=Lucas+Mineiro&background=random"
                        alt="LucasMineiro">
                </div>
                <div class="card-content">
            ...
            <div class="card">
                <div class="card-image-container">
                    <img class="main-image"
                        ...
                        alt="IFMG Bambuí">
                    <img class="overlay-image"
                        src="https://ui-avatars.com/api/?name=Ana+Vet&background=random"
                        alt="AnaVet">
                </div>
                <div class="card-content">
            ...
            <div class="card">
                <div class="card-image-container">
                    ...
                    <img class="overlay-image"
                        src="https://ui-avatars.com/api/?name=Ricardo+Tech&background=random"
                        alt="RicardoTech">
                </div>
                <div class="card-content">
            ...
            <div class="card">
                <div class="card-image-container">
                    ...
                    <img class="overlay-image"
                        src="https://ui-avatars.com/api/?name=Carla+Norte&background=random"
                        alt="CarlaNorte">
                </div>
                <div class="card-content">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h3 class="card-title">Pedro Agro</h3>
                    <p class="card-subtitle">
                        IFNMG - Januária
                    </p>
                </div>
